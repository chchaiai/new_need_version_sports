...
export const ADMIN_GATED_OPERATION_IDS = [
  ...
  "listLimitedReviewGrants",
  "listOwnNotifications",
  "listPublishedSportTemplates",
  "listSemesters",
  "listStudentAccounts",
  "listSubAdmins",
