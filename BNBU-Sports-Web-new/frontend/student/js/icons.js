// Material-icon SVG set replicating the Android app's icon semantics
// (androidx.compose.material:material-icons-extended). 24x24 viewBox.
...
const PATHS = {
  ...
  "add-box": "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z",
  ...
  "directions-run": "M13.49 5.48c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-3.6 13.9 1-4.4 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1l-5.2 2.2v4.7h2v-3.4l1.8-.7-1.6 8.1-4.9-1-.4 2 7 1.4z",
  "sports-basketball": "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm7.5 8.3c-1.9-.2-3.7.1-5.3.8-.4-1-.9-1.9-1.5-2.8 1.2-1.4 2.1-3 2.5-4.6a8 8 0 0 1 4.3 6.6zM12 4c.4 0 .8 0 1.2.1-.4 1-1 2-1.7 2.9A22 22 0 0 0 8 4.9 8 8 0 0 1 12 4zM6.3 6.2c1.4.6 2.7 1.4 3.8 2.4a17 17 0 0 1-5.8 2A8 8 0 0 1 6.3 6.2zM4.2 12.7c2.6-.2 5-.9 7.2-2.2.4.7.8 1.4 1.1 2.2a12 12 0 0 0-5.3 5.1 8 8 0 0 1-3-5.1zm5 6.2a10 10 0 0 1 4-4.2c.4 1.6.5 3.2.4 4.9A8 8 0 0 1 9.2 19zm6.5-.1c0-1.7-.2-3.4-.7-5 1.4-.6 2.9-.8 4.5-.6a8 8 0 0 1-3.8 5.6z",
  "sports-soccer": "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm3.1 3.1 2.4 1.7-.9 2.8-2.8.1-1.7-2.3 1-2.7 2 .4zM8.9 5l2 .1-.7 2.1-2.5 1.9-2-.8A8 8 0 0 1 8.9 5zm-4.8 5.2 2.8.9.9 3-1.9 2.2-1.3-.3A8 8 0 0 1 4 12l.1-1.8zm3.4 7.4 1.7-2h3.3l1.7 2.1-.8 2.1A8 8 0 0 1 7.5 17.6zm8 .7.7-1.9-1.8-2.3 1-3 2.8-.8 1.7 1.3v.4a8 8 0 0 1-4.4 6.3z",
  "sports-badminton": "M5.2 3.4 11 9.2 9.2 11 3.4 5.2l1.8-1.8zm6.5 6.5 2.4 2.4-1.8 1.8-2.4-2.4 1.8-1.8zm3.8 3.8 5.1 5.1-1.8 1.8-5.1-5.1 1.8-1.8zM15 3l1.2 5.2L12 5l3-2zm3 1 2 4.8-4.8-2L18 4zm2.8 3.2.2 5.3-4-3.9 3.8-1.4z",
  "sports-table-tennis": "M4 4h12a4 4 0 0 1 0 8h-2.2l-2.4 2.4 4.2 4.2-2 2-4.2-4.2-1.2 1.2-2.8-2.8L12.2 8H4V4zm13.5 11.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5z",
  pool: "M3 18h18v2H3v-2zm2.5-2c-1 0-1.8-.3-2.5-.9v-2.5c.7.9 1.5 1.4 2.5 1.4s1.8-.5 2.5-1.4c.7.9 1.5 1.4 2.5 1.4s1.8-.5 2.5-1.4c.7.9 1.5 1.4 2.5 1.4s1.8-.5 2.5-1.4c.7.9 1.5 1.4 2.5 1.4v2c-1 0-1.8-.3-2.5-.9-.7.6-1.5.9-2.5.9s-1.8-.3-2.5-.9c-.7.6-1.5.9-2.5.9s-1.8-.3-2.5-.9c-.7.6-1.5.9-2.5.9zM6.7 9.5 10 6.2l2 2L9.5 11 6.7 9.5zM13 3a2 2 0 1 1 0 4 2 2 0 0 1 0-4zm1 5.5 2-1.5 4 3-1.2 1.6L16 9.5l-1.7 1.3-2-1.1L14 8.5z",
  "directions-bike": "M5.5 6.5A1.5 1.5 0 1 1 5.5 3a1.5 1.5 0 0 1 0 3.5zM18.5 21a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9zm0-2a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zM5.5 21a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9zm0-2a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm4.8-8.8 2.2 2.3 1.2-3H17V7h-4.6l-1 2.5-1.9-2H7v2h1.7l-2.2 5.2 1.8.8 2-4.7z",
  ...
  stop: "M6 6h12v12H6z",
  "camera-alt": "M9 2 7.17 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9zm3 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8.2c-1.77 0-3.2 1.43-3.2 3.2s1.43 3.2 3.2 3.2 3.2-1.43 3.2-3.2-1.43-3.2-3.2-3.2z",
  ...
  "privacy-tip": "M12 1 3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-1 6h2v2h-2V7zm0 4h2v6h-2v-6z",
  ...
  description: "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z",
  ...
  palette: "M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c3.31 0 6-2.69 6-6 0-4.42-4.03-8-10-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z",
  warning: "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z",
  history: "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",
  "upload-file": "M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6zm5-1h2v-4h3l-4-5-4 5h3v4z",
  ...
  "photo-library": "M22 16V4c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2zm-11-4 2.03 2.71L16 11l4 5H8l3-4zM2 6v14c0 1.1.9 2 2 2h14v-2H4V6H2z",
  ...
  "check-circle-outline": "M16.59 7.58 10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z",
  ...
  "fitness-center": "M20.57 14.86 22 13.43 20.57 12 17 15.57 8.43 7 12 3.43 10.57 2 9.14 3.43 7.71 2 5.57 4.14 4.14 2.71 2.71 4.14l1.43 1.43L2 7.71l1.43 1.43L2 10.57 3.43 12 7 8.43 15.57 17 12 20.57 13.43 22l1.43-1.43L16.29 22l2.14-2.14 1.43 1.43 1.43-1.43-1.43-1.43L22 16.29z",
};
...
export function emblem(size = 24, cls = "") {
  return `<svg class="icon emblem ${cls}" width="${size}" height="${size}" viewBox="0 0 83 83" fill="currentColor" aria-hidden="true"><use href="#bnbu-emblem-path"/></svg>`;
}
